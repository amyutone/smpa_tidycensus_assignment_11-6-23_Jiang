---
title: "Tidyverse Census Assignment - WITH SOLUTIONS"
author: ""
format: html
---
...
**Q1** What is the Maryland jurisdiction with the lowest median age, according to the ACS 2021 5-year estimates? You will need to find the variable for median age first. **A1** Baltimore City, with an estimated median age of 35.5 years and a margin of error of 0.2 years.
...
```{r}
md_population_5_17 <- get_acs(geography = 'county', 
                              variables = c(total_pop_5_17 = 'B16004_002'), 
                              state = 'MD', 
                              year = 2020) %>%
...
combined_5_17 <- speak_spanish_5_17 %>%
  ...
  mutate(
    pct_of_total = (speak_spanish_5_17/total_pop_5_17)*100
    ) %>%
